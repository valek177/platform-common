...
//go:generate minimock -i github.com/valek177/platform-common/pkg/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/valek177/platform-common/pkg/client/db"
)
